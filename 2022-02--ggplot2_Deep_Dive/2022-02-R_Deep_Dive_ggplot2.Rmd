...
Let's make one more plot based on the periodic table. Copy your plot from Exercise 
6.4, and choose another continuous numeric variable to plot. Some choices are:
