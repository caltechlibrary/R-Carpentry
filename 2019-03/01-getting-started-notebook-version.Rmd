...
2. Under the `File` menu, click on `New Project`. Choose `Existing Directory`, then
  browse through your local files to select the folder created for your workshop download.
3. Click on `Create Project`. Note that an `.Rproj` file is automatically added to the project folder. This file marks the location of your project's working directory.
